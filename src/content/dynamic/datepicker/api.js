...
const markdownContent = 'https://raw.githubusercontent.com/AlaskaAirlines/auro-datepicker/main/demo/api.md';

class AuroDatepickerApi extends MarkdownPageWrapper {

  componentDidMount() {
    window.initDatepickerApiExamples();
  }
...
export default AuroDatepickerApi;
