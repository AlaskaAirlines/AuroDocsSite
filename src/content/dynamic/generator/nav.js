  ...
  render() {
    return (
      <div role="tablist" className="tabList">
        ...
        <NavLink role="tab" exact className="tab link" to={`/getting-started/developers/generator/development-setup`} activeClassName="is-active">Development setup</NavLink>
