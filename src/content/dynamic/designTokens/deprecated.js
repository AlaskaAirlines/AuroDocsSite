...
import { Nav } from './nav';
import deprecated from '@aurodesignsystem/design-tokens/dist/tokens/JSObject--deprecated.js';
  ...
  render() {
    return (
      <section>
        ...
        <h2 className="auro_heading auro_heading--700">Post v4.5 DELETED tokens</h2>
        <p>The following tokens have been REMOVED FROM THE PROJECT as v4.5. Please note the version of deprecation notice.</p>
        <auro-tokenlist type="deprecated" version componentData={this._getTokens(deprecated, [])}></auro-tokenlist>
      </section>
    );
  }
}
