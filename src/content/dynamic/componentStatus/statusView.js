  ...
  render() {
    return (
      <section>
        ...
        {/* <p>
          <auro-alert type="information" noIcon>
            <div style={{display: 'flex'}}>
              <auro-icon category="interface" name="chat" accent customSize style={{ width: '100px', height: '90px', 'margin-right': '1rem'}}></auro-icon>
              <div>
                Have ideas you want to share or need more information about Auro? Please feel free to start a new discussion with the team
                <auro-hyperlink href="https://www.portseattle.org/sea-tac" target="_blank" >CTA Button</auro-hyperlink>
              </div>
            </div>
          </auro-alert>
        </p> */}
