...
const markdownContent = 'https://raw.githubusercontent.com/AlaskaAirlines/auro-toast/main/demo/apiExamples.md';

class AuroToastApi extends MarkdownPageWrapper {

  componentDidMount() {
    window.initToastApiExamples();
  }
