  ...
  render() {
    return (
      <section id="icons" className="auro_baseType">
        ...
        <p className="auro_baseParagraph" style={{ marginTop: 'var(--ds-size-200)' }}>Over time, things change. And sadly some things must go away. Please monitor this list of icons as they will be removed with the next MAJOR release of Auro icons. </p>
