<auro-header level="2">Using transparent colors</auro-header>
...
<auro-header level="3">Using Sass</auro-header>
...
Using Sass `color-mix` to create opacity levels will output a final RGBA value. Support for `color-mix` can be seen in this <auro-hyperlink href="https://caniuse.com/mdn-css_types_color_color-mix" target="_blank">caniuse page</auro-hyperlink>.

In this example use `$ds-color-brand-alpine-400` to create some opacity examples. Notice the use of a modifier in the <auro-hyperlink href="/css/conventions" relative>naming convention</auro-hyperlink>.
...
<auro-header level="3">Using CSS</auro-header>
...
Using CSS to create opacity levels will not be compatible with browsers that do not <auro-hyperlink href="https://caniuse.com/#feat=css-variables" target="_blank">support custom properties</auro-hyperlink>.

Also, support for `color-mix` can be seen in this <auro-hyperlink href="https://caniuse.com/mdn-css_types_color_color-mix" target="_blank">caniuse page</auro-hyperlink>.

In this example we use `var(--ds-color-brand-alpine-400)` to create some opacity examples. Notice the use of a modifier in the <auro-hyperlink href="/css/conventions" relative>naming convention</auro-hyperlink>.
...
The examples below illustrate using these RGB tokens with the <auro-hyperlink href="https://developer.mozilla.org/en-US/docs/Web/CSS/color_value#RGB_colors" target="_blank">RGBA CSS function</auro-hyperlink>.
