  ...
  const [siteNav, setNav] = useState([
    ...
    },
    {
      ...
      items: [
        ...
        { linkTitle: "Alert (BETA)", route: '/components/auro/alert', parent: true },
        { linkTitle: "Avatar (BETA)", route: '/components/auro/avatar', parent: true },
        ...
        { linkTitle: "Button (BETA)", route: '/components/auro/button', parent: true },
        ...
        { linkTitle: "Combobox (BETA)", route: '/components/auro/combobox', parent: true },
        ...
        { linkTitle: "Dialog (BETA)", route: '/components/auro/dialog', parent: true },
        { linkTitle: "Drawer (BETA)", route: '/components/auro/drawer', parent: true },
        { linkTitle: "Dropdown (BETA)", route: '/components/auro/dropdown', parent: true },
        ...
        { linkTitle: "Icon (BETA)", route: '/components/auro/icon', parent: true },
        { linkTitle: "Input (BETA)", route: '/components/auro/input', parent: true },
        { linkTitle: "Loader (BETA)", route: '/components/auro/loader', parent: true },
        { linkTitle: "Lockup", route: '/components/auro/lockup', parent: true },
        { linkTitle: "Menu (BETA)", route: '/components/auro/menu', parent: true },
        { linkTitle: "Nav", route: '/components/auro/nav', parent: true },
        { linkTitle: "Pane", route: "/components/auro/pane/", parent: true },
        { linkTitle: "Popover (BETA)", route: '/components/auro/popover', parent: true },
        { linkTitle: "Radio (BETA)", route: '/components/auro/radio', parent: true },
